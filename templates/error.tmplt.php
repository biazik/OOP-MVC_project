  ...
  <div class="content-wrapper" style="width: 100%; margin: 0;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Wystąpił błąd krytyczny</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="javascript:window.location.href=window.location.href">Strona główna</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fas fa-exclamation-triangle text-danger"></i> Oops! Coś poszło nie tak.</h3>

          <p>
            Pracujemy nad tym, żeby to naprawić<br>
            Na ten moment, możesz <a href="javascript:window.location.href=window.location.href">wrócić do strony głównej</a>, albo skontaktować się z administratorem.
          </p>
