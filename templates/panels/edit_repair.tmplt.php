...
<!-- SHOW ERROR IS IN TABLE PANEL -->
  <!-- /.card-header -->
  <form action="" method="post" id="edit_repair_form">
    <div class="card-body">
    ...
    <div class="card-footer">
      ...
      <button type="submit" name="edit_repair" class="btn btn-success">Edytuj</button>
    </div>
  </form>
</div>
...
<script>
  ...
  $('#edit_repair_form').validate({
    ...
    messages: {
        edit_description: "Opis naprawy nie może być pusty"
    },
    errorElement: 'span',
